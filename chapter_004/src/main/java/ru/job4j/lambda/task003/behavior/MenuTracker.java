package ru.job4j.lambda.task003.behavior;

import ru.job4j.lambda.task003.input.Input;
import ru.job4j.lambda.task003.models.Item;
import ru.job4j.lambda.task003.models.Task;
import ru.job4j.lambda.task003.models.Tracker;
...
public class MenuTracker {
    ...
    private class AddItem extends BaseAction {
        ...
        public void execute(Input input, Tracker tracker) {
            ...
            tracker.add(new Item(new Item().getId(), name, desc, Long.parseLong(created), new String[]{comments}));
        }
    }
